...
namespace Revit.SDK.Samples.BoundaryConditions.CS
{
    ...
    public class BoundaryConditionsData
    {
        ...
        private Dictionary<int, Autodesk.Revit.DB.BoundaryConditions> m_bCsDictionary =
                new Dictionary<int, Autodesk.Revit.DB.BoundaryConditions>();
        ...
        /// </summary>
        public Dictionary<int, Autodesk.Revit.DB.BoundaryConditions> BCs
        {
            get
            {
        ...
        private delegate Autodesk.Revit.DB.BoundaryConditions
