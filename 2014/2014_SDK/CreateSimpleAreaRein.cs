    ...
    public class Command : IExternalCommand
    {
        ...
        private bool CreateAreaReinOnFloor(Floor floor)
        {
            ...
            if (createForm.ShowDialog() == DialogResult.OK)
            {
                ...
                //Create AreaReinforcement
                AreaReinforcement areaRein = AreaReinforcement.Create(m_revit.Application.ActiveUIDocument.Document, floor, curves, majorDirection);
        ...
        private bool CreateAreaReinOnWall(Wall wall)
        {
            ...
            if (createForm.ShowDialog() == DialogResult.OK)
            {
                ...
                AreaReinforcement areaRein = AreaReinforcement.Create(m_revit.Application.ActiveUIDocument.Document, wall, curveList, majorDirection);
