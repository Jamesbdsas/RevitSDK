   ...
   public class Command : IExternalCommand
   {
      ...
      private void MakeNewTruss()
      {
         ...
         if (null != topChord)
         {
            ...
            m_familyCreator.NewAlignment(level1, geometryCurve.GetEndPointReference(0), left.Reference);
            m_familyCreator.NewAlignment(level1, geometryCurve.GetEndPointReference(0), bottom.Reference);
            // Lock the end point of top chord to the Intersection of right and top reference plan
            m_familyCreator.NewAlignment(level1, geometryCurve.GetEndPointReference(1), top.Reference);
            m_familyCreator.NewAlignment(level1, geometryCurve.GetEndPointReference(1), right.Reference);
         }
