...
namespace Revit.SDK.Samples.ImportExport.CS
{
    ...
    public class ExportDXFData : ExportDataWithViews
    {
        ...
        private void Initialize()
        {
            ...
            m_fileVersion.Add("AutoCAD 2004 DXF Files (*.dxf)");
            m_enumFileVersion.Add(Autodesk.Revit.DB.ACADVersion.R2004);
            m_fileVersion.Add("AutoCAD 2000 DXF Files (*.dxf)");
            m_enumFileVersion.Add(Autodesk.Revit.DB.ACADVersion.R2000);
