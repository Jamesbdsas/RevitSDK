...
namespace CodeCheckingConcreteExample.Concrete
{
   ...
   public class Reinforcement
   {
      ...
      /// </summary>
      /// <remarks>
      /// For longitudinal reinforcement: the final areas are set as maksimum of current value and previous final value. </br>
      /// For transversal reinforcement: the final areas are set as sum of current value and previous final value,
      /// final spacing is set as minimum of current spacing and previous final spacing.
      /// </remarks>
