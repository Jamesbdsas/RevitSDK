...
namespace SectionPropertiesExplorer
{
    ...
    public partial class SlabDescriptionControl : UserControl
    {
        ...
        private void AddToRenderInSlabsViewer(double scale)
        {
            ...
            {
                if (null == slabsInfo.TSection.Adjoinings || slabsInfo.TSection.Adjoinings.Count < 1)
                {
                    return;
                }
            ...
            if (null == slabsInfo.AsElement && null == slider)
            {
                ...
                GetViewerWidthAndHeight(slabsViewer, out viewerWidth, out viewerHeight);
        ...
        {
            double width, height;
            GetViewerWidthAndHeight(tSectionViewer, out width, out height);
        ...
        private void GetViewerWidthAndHeight(Canvas viewer, out double width, out double height)
        {
        ...
        {
            double viewerWidth, viewerHeight;
            GetViewerWidthAndHeight(viewer, out viewerWidth, out viewerHeight);
