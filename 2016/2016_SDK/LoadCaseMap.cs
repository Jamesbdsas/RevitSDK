...
namespace Revit.SDK.Samples.Loads.CS
{
    ...
    public class LoadCasesMap
    {
        ...
        Autodesk.Revit.DB.Structure.LoadNatureCategory m_loadCasesCategory;//Store the LoadNatureCategory of the load case's category
        ...
        /// CategoryId property.
        /// </summary>
        public Autodesk.Revit.DB.Structure.LoadNatureCategory LoadNatureCategory
        {
            get
            {
            ...
            set
            {
                m_loadCasesCategory = value;
                m_loadCase.NatureCategory = m_loadCasesCategory;
            }
        }
