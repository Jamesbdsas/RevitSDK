...
namespace Revit.SDK.Samples.Loads.CS
{
    ...
    public class Loads : IExternalCommand
    {
        ...
        List<LoadNatureCategory> m_loadNaturesCategory;     //Store the load case's category
        ...
        /// <summary>
        /// save all load nature category in current project
        /// </summary>
        public List<LoadNatureCategory> LoadNatureCategories
        {
            get
            {
                return m_loadNaturesCategory;
            }
        }
        ...
        public Loads()
        {
            ...
            m_loadNaturesCategory = new List<LoadNatureCategory>();
